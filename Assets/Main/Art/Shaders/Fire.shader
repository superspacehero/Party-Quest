...
Shader "Fire"
{
	Properties
	{
		...
		[ASEBegin][HDR]_Color("Color", Color) = (2.274588,0.7757972,0.2274589,1)
		_FlameSpeed("Flame Speed", Float) = 0.5
		_NoiseScale("Noise Scale", Float) = 1
		_YScale("Y Scale", Float) = 1.05
		[ASEEnd]_DistortStrength("Distort Strength", Float) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult11 = (float2(0.0 , -mulTime7));
				float simplePerlin2D13 = snoise( (IN.ase_texcoord3.xy*_NoiseScale + appendResult11)*5.0 );
				simplePerlin2D13 = simplePerlin2D13*0.5 + 0.5;
				float2 appendResult37 = (float2(0.0 , ( IN.ase_texcoord3.xy.y * ( _DistortStrength * ( simplePerlin2D13 - 0.5 ) ) )));
				float2 break32 = (IN.ase_texcoord3.xy*appendResult35 + appendResult37);
				float temp_output_29_0 = pow( saturate( ( 1.0 - break32.y ) ) , 2.0 );
				float2 appendResult31 = (float2(break32.x , ( 1.0 - temp_output_29_0 )));
				float2 appendResult11_g2 = (float2(0.5 , 0.7));
				float temp_output_17_0_g2 = length( ( (appendResult31*2.0 + -1.0) / appendResult11_g2 ) );
				float4 temp_cast_0 = (( ( temp_output_29_0 + 0.3 ) * 1.5 )).xxxx;
				float div24=256.0/float(4);
				float4 posterize24 = ( floor( temp_cast_0 * div24 ) / div24 );
				
				float2 appendResult11_g1 = (float2(0.9 , 0.9));
				float temp_output_17_0_g1 = length( ( (appendResult31*2.0 + -1.0) / appendResult11_g1 ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _Color * ( saturate( ( ( 1.0 - temp_output_17_0_g2 ) / fwidth( temp_output_17_0_g2 ) ) ) + posterize24 ) ).rgb;
				float Alpha = saturate( ( ( 1.0 - temp_output_17_0_g1 ) / fwidth( temp_output_17_0_g1 ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float mulTime7 = _TimeParameters.x * _FlameSpeed;
				float2 appendResult11 = (float2(0.0 , -mulTime7));
				float simplePerlin2D13 = snoise( (IN.ase_texcoord2.xy*_NoiseScale + appendResult11)*5.0 );
				simplePerlin2D13 = simplePerlin2D13*0.5 + 0.5;
				float2 appendResult37 = (float2(0.0 , ( IN.ase_texcoord2.xy.y * ( _DistortStrength * ( simplePerlin2D13 - 0.5 ) ) )));
				float2 break32 = (IN.ase_texcoord2.xy*appendResult35 + appendResult37);
				float temp_output_29_0 = pow( saturate( ( 1.0 - break32.y ) ) , 2.0 );
				float2 appendResult31 = (float2(break32.x , ( 1.0 - temp_output_29_0 )));
				float2 appendResult11_g1 = (float2(0.9 , 0.9));
				float temp_output_17_0_g1 = length( ( (appendResult31*2.0 + -1.0) / appendResult11_g1 ) );
...
/*ASEBEGIN
Version=18934
1720;36;1720;1335;-80.95081;264.2272;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;8;-1565.729,51.3843;Inherit;False;Property;_FlameSpeed;Flame Speed;1;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;7;-1547.729,142.3843;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;9;-1521.73,229.3842;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-1174.73,147.3843;Inherit;False;Property;_NoiseScale;Noise Scale;2;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;41;-127.7265,212.0161;Inherit;False;Property;_DistortStrength;Distort Strength;4;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;36;258.8309,-142.6109;Inherit;False;Property;_YScale;Y Scale;3;0;Create;True;0;0;0;False;0;False;1.05;1.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;6;2034.742,104.7384;Inherit;False;Constant;_AlphaClip;Alpha Clip;0;0;Create;True;0;0;0;False;0;False;0.1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;26;1310.737,136.7919;Inherit;False;Ellipse;-1;;2;3ba94b7b3cfd5f447befde8107c04d52;0;3;2;FLOAT2;0,0;False;7;FLOAT;0.5;False;9;FLOAT;0.7;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;25;1315.737,539.7919;Inherit;False;Ellipse;-1;;1;3ba94b7b3cfd5f447befde8107c04d52;0;3;2;FLOAT2;0,0;False;7;FLOAT;0.9;False;9;FLOAT;0.9;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;21;1622.864,-132.1679;Inherit;False;Property;_Color;Color;0;1;[HDR];Create;True;0;0;0;False;0;False;2.274588,0.7757972,0.2274589,1;2.274588,0.7757972,0.2274589,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.BillboardNode;19;1997.864,179.8321;Inherit;False;Spherical;False;True;0;1;FLOAT3;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2;2205.254,25.88057;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;3;Fire;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;0;0;  Blend;0;0;Two Sided;1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;5;False;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=00CFFE1860A173C13701E3B4DED3334C89F46418