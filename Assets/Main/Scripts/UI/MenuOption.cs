...
public class MenuOption : MonoBehaviour
{
    #region Static Variables
        ...
        public static MenuOption currentMenuOption
        {
        ...
        private static MenuOption _currentMenuOption;

        public static List<MenuOption> menuOptions = new List<MenuOption>();

        private static void FindMenuOptions()
        {
            foreach (MenuOption menuOption in FindObjectsOfType<MenuOption>())
                menuOptions.Add(menuOption);
        }

        private static void DeselectMenuOption(MenuOption exceptingMenuOption)
        {
    ...
    #region Other Menu Options
        ...
        public MenuOption previousOption, nextOption;
